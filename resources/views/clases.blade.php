                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="{{url('carrito')}}" onsubmit="fbq('track', 'AddToCart');"
                                            ...
                                            <div id="myCarouselgrande{{$clase->id}}" class="carousel slide hidden-xs"
                                                 data-wrap="false">
                                                    ...
                                                    @for ($i=0; $i < 5 ; $i++)
                                                        @if ($i==0)
                                                                                                ...
                                                                                                @if (!$existe)
                                                                                                    @if (!in_array($fechas[$x], $libres) && ($particular->fecha==$fechas[$x]||in_array($dia_n, explode(",",$particular->recurrencia))))
                                                                                                        ...
                                                                                                        <li class="list-group-item"
                                                                                                            onclick="agregaracarrito('{{$x}}{{$particular->id}}{{$i}}','{{$particular->clase->id}}','{{$clase->id}}');"
                                                            ...
                                                            <a class="left carousel-control"
                                                               href="#myCarouselgrande{{$clase->id}}" data-slide="prev"><em
                                                                        class="fa fa-2x fa-chevron-left"
                                                                        aria-hidden="true" style="color: #000;"></em>
                                                            </a>
                                                            <a class="right carousel-control"
                                                               href="#myCarouselgrande{{$clase->id}}" data-slide="next"><em
                                            ...
                                            <div id="myCarousel{{$clase->id}}" class="carousel slide visible-xs"
                                                 data-wrap="false">
                                                <div class="carousel-inner">
                                                    @for ($i=0; $i < 15 ; $i++)
                                                        @if ($i==0)
                                                                                            ...
                                                                                            @if($particular->tipo!="En condominio")
                                                                                                ...
                                                                                                @if (!$existe)
                                                                                                    @if (!in_array($fechas[$x], $libres) && ($particular->fecha==$fechas[$x]||in_array($dia_n, explode(",",$particular->recurrencia))))
																										<?php $nombre = explode( " ", $particular->user->name ); ?>
                                                                                                        <li class="list-group-item"
                                                                                                            onclick="agregaracarrito('{{$x}}{{$particular->id}}{{$i}}mini','{{$particular->clase->id}}','{{$clase->id}}');"
                                                                                                            style="cursor:pointer;">
                                                                                                            <input type="checkbox"
                                                                                                                   class="carritocheck"
                                                            ...
                                                            <a class="left carousel-control"
                                                               href="#myCarousel{{$clase->id}}" data-slide="prev"><em
                                                                        class="fa fa-2x fa-chevron-left"
                                                                        aria-hidden="true" style="color: #000;"></em>
                                                            </a>
                                                            <a class="right carousel-control"
                                                               href="#myCarousel{{$clase->id}}" data-slide="next"><em
                                                                        class="fa fa-2x fa-chevron-right"
                                                                        aria-hidden="true" style="color: #000;"></em>
                                                            </a>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="submit" class="btn btn-success btn-lg" name=""
                                                               value="Reservar"
                                                               id="reservar{{$clase->id}}{{$clase->id}}" disabled>
                                                    </div>
                                                </div>
                                        </form>
                                    </div>
