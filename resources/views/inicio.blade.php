...
@section('pagecontent')
        ...
        <div class="homeBxSliderWrap">
            <div class="homeBxSlider">
                @foreach ($sliders as $slider)
                    <div class="slide" data-slide="{{ $slider->id-1	}}"
                         style="background-image: url({{ url('images/content/')}}/{{ $slider->image	}});">
    ...
    <section class="paquetes hidden-sm hidden-xs">
                    ...
                    <div class="row text-center">
                        <div class="paquete-center">
                            ...
                            <div class="col-md-2 col-xs-6">
                                <div class="paquete" onclick="location.href='{{url('/clasesdeportivas')}}'"
                                     style="cursor:pointer; color: #EF7E19; border: 0;">
                            ...
                            @foreach($particulares as $paquete)
                                @if($paquete->paquete=="Primer clase")
                                    <div class="col-md-2 col-xs-6">
                                        <div class="paquete"
                                             @if(Auth::guest())  onclick="document.getElementById('loginboton').click()"
                                             @else onclick="location.href='{{url('/comprar-paquete')}}/{{$paquete->id}}'"
                                             @endif style="cursor:pointer; color: #EF7E19;">
                    ...
                    <div class="row text-center">
                        <div class="paquete-center">
                            <div class="col-md-2 col-xs-6">
                                <div class="paquete"
                                     @if(Auth::guest())  onclick="document.getElementById('loginboton').click()"
                                     @else  onclick="location.href='{{url('/condominios')}}'"
                                     @endif style="cursor:pointer; color: #EF7E19; border: 0;">
                                ...
                                @if($paquete->paquete=="Primer clase")
                                    <div class="col-md-2 col-xs-6">
                                        <div class="paquete"
                                             @if(Auth::guest())  onclick="document.getElementById('loginboton').click()"
                                             @else  onclick="location.href='{{url('/comprar-paquete')}}/{{$paquete->id}}'"
                                             @endif style=" color: #EF7E19; cursor:pointer;">
                                            <div class="blue-cap"></div>
                                            <div class="info-paquete">
                                                <div class="circulo gotham2">
                                                    <i class="fa fa-gift" aria-hidden="true"></i>
    ...
    <section class="paquetes visible-sm visible-xs">
        <div class="container-bootstrap">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1 class="title">COMPRAR CLASES</h1>
