...
<head>
    ...
    <meta name="description"
          content="Nuestro objetivo es activar las áreas comunes de los condominios dándoles una administración de club deportivo. Actividades deportivas, culturales y sociales en la comodidad de tu casa.">
    <meta name="keywords"
          content="clases,deportivas,culturales,sociales,curso,verano,carrera,fitcoach,domicilio,instructores,profesores,deportes,interlomas,santa fe,areas,comunes">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('css/main.css?v=1') }}" media="screen"/>
    ...
    <script type="text/javascript">
        ...
        smartlook('init', '2dc9785490b72746428cc3d6e536dff9997e324a');
    </script>
</head>
<body class="home">
<div class="pagecontainer">
        ...
        <div class="headerWrap clear is-sticky">
            <a class="logo" id="logo" href="{{ url('/') }}">
                @if(url('/')==Illuminate\Support\Facades\URL::current())
                    <img src="{{ url('images/Logo-Blanco.png') }}" alt="" width="161" height="40" class="logo-white"
                         id="blanco">
                @else
            ...
            <nav class="mainMenu">
                <ul class="clear">
                    ...
                    @if (Auth::guest())
                        <li><a href="#" data-toggle="modal" data-target="#loginmodal" id="loginboton"><i
                                        class="fa fa-user fa-2x" aria-hidden="true"></i></a></li>
                    @elseif (Auth::user()->role=="usuario")
                        <li>
                            <a href="{{url('perfil')}}" data-toggle="tooltip" data-placement="bottom"
                               title="Hola {{strtok(Auth::user()->name, " ")}}"><i class="fa fa-user fa-2x"
                                                                                   aria-hidden="true"></i>
                            </a>
                        </li>
                        <li><a href="{{url('salir')}}"><i class="fa fa-sign-out fa-2x" aria-hidden="true"></i></a></li>
                    @elseif (Auth::user()->role=="instructor")
                        <li><a href="{{url('perfilinstructor')}}" data-toggle="tooltip" data-placement="bottom"
                               title="Hola {{strtok(Auth::user()->name, " ")}}"><i class="fa fa-user fa-2x"
                                                                                   aria-hidden="true"></i></a></li>
                        <li><a href="{{url('salir')}}"><i class="fa fa-sign-out fa-2x" aria-hidden="true"></i></a></li>
                    @elseif (Auth::user()->role=="admin"||Auth::user()->role=="superadmin")
                        <li><a href="{{url('admin')}}" data-toggle="tooltip" data-placement="bottom"
                               title="Hola {{strtok(Auth::user()->name, " ")}}"><i class="fa fa-user fa-2x"
                                                                                   aria-hidden="true"></i></a></li>
                        <li><a href="{{url('salir')}}"><i class="fa fa-sign-out fa-2x" aria-hidden="true"></i></a></li>
                @endif
    ...
    <footer id="footer" class="clear">
        ...
        <div class="footerSubscribe">
            <form action="//fitcoach.us16.list-manage.com/subscribe/post?u=0b165717bbc98ca53d19e7bbf&amp;id=b27b9f9a8e"
                  method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate"
                  target="_blank" novalidate>
                <input class="" type="email" value="" name="EMAIL" id="mce-EMAIL" size="20" value=""
                       placeholder="Email">
                <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text"
                                                                                          name="b_0b165717bbc98ca53d19e7bbf_b27b9f9a8e"
                                                                                          tabindex="-1" value=""></div>
                <button id="mc-embedded-subscribe" class="btnSubscribe" type="submit"><i class="fa fa-envelope"
                                                                                         aria-hidden="true"></i>
                </button>
            </form>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-8 col-sm-3 col-lg-3 text-center centrartotal" style="cursor: default !important;">
                <button type="button" class="close visible-xs" data-dismiss="modal" aria-label="Close"><img
                ...
                <div id="login1">
                    ...
                    <button id="btn-login" class="btn btn-success" onclick="userExist()"
                ...
                <div id="login2" style="display: none;">
                    ...
                    <form id="loginform" class="form-horizontal" role="form" action="{{ url('/entrar') }}"
                          method="post">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input id="emaillogin1" type="email" class="form-control" name="email"
                               value="{{ old('email') }}" placeholder="Correo electrónico" required>
                        <input id="passlogin1" type="password" class="form-control" name="password"
                ...
                <div id="login3" style="display: none;">
                    ...
                    <form id="loginform" class="form-horizontal" onsubmit="fbq('track', 'CompleteRegistration');"
                          role="form" action="{{ url('/registro') }}" method="post">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input id="emaillogin2" type="email" class="form-control" name="email"
                               value="{{ old('email') }}" placeholder="Correo electrónico" required>
                        <input type="email" class="form-control" name="email_confirmation"
                               value="{{ old('email_confirmation') }}" placeholder="Confirmar correo electrónico"
                               required>
                        ...
                        <input type="tel" class="form-control" name="tel" value="{{ old('tel') }}" minlength="10"
                        ...
                        <div class="checkbox" style="padding: 10px 0;">
                            <input type="checkbox" name="términos" value="Sí" required> <a
                                    href="{{url('/legales')}}?page=terminos"
                                    style="text-decoration: none; color: #000;">Acepto términos y condiciones y</a> <a
                                    href="{{url('/legales')}}?page=terminos"
                                    style="text-decoration: none; color: #000;">aviso de privacidad.</a>
                        </div>
                ...
                <div id="retrievepssw" style="display: none;">
                    ...
                    <form class="row" action="{{ url('/password/email ') }}" method="post">
                        <input class="form-control" type="email" value="{{ old('email') }}" placeholder="tu@email.com"
                               name="email">
                        {!! csrf_field() !!}
                        <button class="btn btn-success" type="submit"
                                style="color: #fff !important; background-color: #D58628 !important; border-color: rgba(213, 134, 40, 0.64) !important;">
