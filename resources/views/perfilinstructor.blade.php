                  ...
                  <div class="container-bootstrap" style="width: 100%;">
                      ...
                      <form action="{{ url('/planear-clase') }}" method="post" enctype="multipart/form-data">
                        ...
                        {{$proxima->plan}}
                          ...
                          <label>Fase inicial</label>
                          <textarea name="inicio" class="form-control" required>{{$proxima->plan->inicio}}</textarea>
                          <label>Minutos</label>
                          <input type="number" class="form-control" name="minutosinicio" value="{{$proxima->plan->minutosinicio}}" required>

                          <label>Fase medular</label>
                          <textarea name="medular" class="form-control" required>{{$proxima->plan->medular}}</textarea>
                          <label>Minutos</label>
                          <input type="number" class="form-control" name="minutosmedular" value="{{$proxima->plan->minutosmedular}}" required>

                          <label>Fase final</label>
                          <textarea name="final" class="form-control" required>{{$proxima->plan->final}}</textarea>
                          <label>Minutos</label>
                          <input type="number" class="form-control" name="minutosfinal" value="{{$proxima->plan->minutosfinal}}" required>

                          <label>Comentarios</label>
                          <textarea name="comentarios" class="form-control" required>{{$proxima->plan->comentarios}}</textarea>
                          <input type="hidden" name="reservacion_id" value="{{$proxima->id}}">
               ...
               <div class="container-bootstrap" style="width: 100%;">
                 <div class="row">
                   <div class="col-sm-12">
                     ...
                     <div class="gotham2">
                       <h2 class="text-center">Terminar {{$proxima->nombre}} {{$proxima->fecha}} - {{$proxima->hora}}</h2>
