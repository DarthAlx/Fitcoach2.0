                                        ...
                                        <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="mcnImageContent" valign="top"
                                                    ...
                                                    <img align="left" alt=""
                                                         src="https://gallery.mailchimp.com/0b165717bbc98ca53d19e7bbf/images/616a59bb-7326-4fae-be59-99d01df7e6e4.png"
                                                         width="438"
                                                         style="max-width:438px; padding-bottom: 0; display: inline !important; vertical-align: bottom;"
                                                         class="mcnImage">
                                                            ...
                                                            <td colspan="2">
                                                                <table class="border" width="100%" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 30%;"><span>Artículo</span>
                                                                        </td>
                                                                        <td style="width: 30%;"><span>Descripción</span>
                                                                        </td>
                                                                        <td style="width: 30%;"><span>Clientes</span>
                                                                        </td>
                                                                ...
                                                                <table width="100%" class="textb" border="0"
                                                                       cellspacing="0" cellpadding="6">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <p class="text-left">Revisa tu perfil para
                                                                                saber todos los detalles de la clase.
                                                                                <br></p>

                                                                            <p class="text-center">Gracias por ser parte
                                                                                de FITCOACH.</p>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                ...
                                <tr>
                                    <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;"
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0"
                                               ...
                                               style="border-collapse: separate !important;border-radius: 3px;background-color: #EF7E19;">
                                            <tbody>
                                            <tr>
                                                <td align="center" valign="middle" class="mcnButtonContent"
                                                    style="font-family: Arial; font-size: 16px; padding: 15px;">
                                                    <a class="mcnButton " title="IR A PERFIL"
                                                       href="{{url('/')}}?fromemail=true" target="_blank"
                                                       style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">IR
                                                        A PERFIL</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                                                                                    ...
                                                                                                    <table align="left"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td align="center"
                                                                                                                ...
                                                                                                                <a href="http://www.facebook.com/fitcoachmx"
                                                                                                                   target="_blank"><img
                                                                                                    ...
                                                                                                    <table align="left"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td align="center"
                                                                                                                ...
                                                                                                                width="24"
                                                                                                                class="mcnFollowIconContent">
                                                                                                                <a href="mailto:contacto@fitcoach.mx"
                                                                                                                   target="_blank"><img
