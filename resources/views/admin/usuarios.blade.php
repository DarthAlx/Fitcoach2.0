...
@section('pagecontent')
    ...
    <div class="teamItemWrap clear">
			<div class="teamItem">
				<a data-toggle="modal" data-target="#nuevoadmin"><img src="{{ url('images') }}/plus.png" class="img-responsive"></a>
				<div class="overlay">
					<div class="teamItemNameWrap">
						<a style="text-decoration:none;" data-toggle="modal" data-target="#nuevoadmin"><h3>Agregar administrador</h3></a>
					</div>
					<!--p>Formativa</p-->
				</div>
			</div>
	        ...
	        <div class="teamItem">
	          <a data-toggle="modal" data-target="#admin{{$usuario->id}}"><img src="{{ url('images') }}/usuarios_b.png" class="img-responsive"></a>
	          <div class="overlay">
	            <div class="teamItemNameWrap">
	              <a style="text-decoration:none;" data-toggle="modal" data-target="#admin{{$usuario->id}}"><h3>{{ucfirst($usuario->name)}}</h3></a>
	            </div>
	            <!--p>Formativa</p-->
	          </div>
	        </div>
