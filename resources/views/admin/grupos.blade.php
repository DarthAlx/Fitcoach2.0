                ...
                <div class="row">
                    <div class="col-sm-12 text-right">
                        <a href="#" class="btn btn-success btn-lg hidden-xs" style="max-width: 200px;"
                           data-toggle="modal" data-target="#nuevogrupo">Agregar grupo</a>
                        <a href="#" class="btn btn-success btn-lg visible-xs" data-toggle="modal"
                           data-target="#nuevogrupo">Agregar grupo</a>
                    </div>
                </div>
                <p>&nbsp;</p>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div>
                                <a role="button" data-toggle="collapse" href="#actualizargrupo{{$grupo->id}}"
                                   aria-expanded="false" aria-controls="collapseExample" class="btn btn-primary">Actualizar
                                    grupo</a>
                                ...
                                <div class="collapse" id="actualizargrupo{{$grupo->id}}">
                                    <form action="{{ url('/actualizar-grupo') }}" method="post"
                                        ...
                                        <select class="form-control" name="condominio_id"
                                                id="condominio_id{{ $grupo->id }}" required>
                                            <option value="">Selecciona un condominio</option>
                                            @foreach ($condominios as $condominio)
                                                <option value="{{ $condominio->id }}">{{ $condominio->identificador }}</option>
                                            @endforeach
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="adv-table table-responsive">
                                            <table class="display table table-bordered table-striped table-hover"
                                                ...
                                                @foreach ($proximas as $proxima)
                                                    ...
                                                    <tr style="cursor: pointer;">
                                                        ...
                                                        <td>
                                                            <a href="{{url('/printlist')}}/{{$proxima->id}}"
                                                               target="_blank" style="margin: 5px;"><i
                                                                        class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                                                            <a data-toggle="modal"
                                                               data-target="#horario{{$proxima->id}}"
                                                               style="margin: 5px;"><i class="fa fa-pencil"
                                                            ...
                                                            @else
                                                                <a href="#"
                                                                   onclick="javascript: document.getElementById('botoneliminarhorario{{ $proxima->id }}').click();"
                                                                   style="margin: 5px;"><i class="fa fa-close"
                                                                                           aria-hidden="true"></i></a>
                                                                <form style="display: none;"
                                                                      action="{{ url('/eliminar-horariogrupo') }}"
                                                                      method="post">
                                                                    {!! csrf_field() !!}
                                                                    {{ method_field('DELETE') }}
                                                                    <input type="hidden" name="horario_id"
                                                                           value="{{ $proxima->id }}">
                                                                    <input type="submit"
                                                                           id="botoneliminarhorario{{ $proxima->id }}">
                                                                </form>
                                                            @endif
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 text-right">
                                                    <a href="#" class="btn btn-success btn-lg hidden-xs"
                                                       style="max-width: 200px;" data-toggle="modal"
                                                       data-target="#nuevohorario{{$grupo->id}}">Agregar horario</a>
                                                    <a href="#" class="btn btn-success btn-lg visible-xs"
                                                       data-toggle="modal" data-target="#nuevohorario{{$grupo->id}}">Agregar
                                                        horario</a>
                                                </div>
                                            </div>
                                            <p>&nbsp;</p>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div>
                                ...
                                <form action="{{ url('/agregar-horariogrupo') }}" method="post"
                                      enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div>
                                ...
                                <form action="{{ url('/actualizar-horariogrupo') }}" method="post"
                                      enctype="multipart/form-data">
                                    {{ method_field('PUT') }}
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <input class="form-control datepicker" type="text" value="{{ $horario->fecha }}"
                                           placeholder="Fecha" name="fecha" required>
                                    <input id="horarioNuevo" value="{{ $horario->hora }}"
                                           class="form-control xmitimepicker" placeholder="Hora" type="text" name="hora"
                                           required/>
                                <!--select class="form-control"  name="user_id" id="user_id{{ $horario->id }}" >
                                    ...
                                    @else
                                        <div class="text-center">
                                            ...
                                            <a href="#" class="btn btn-success"
                                               style="color: #fff !important; background-color: #d9534f !important; border-color: #d9534f !important; width: 40%; display: inline-block;"
                                               onclick="javascript: document.getElementById('botoneliminarhorario2{{ $horario->id }}').click();">Borrar</a>
                                        </div>
                                    @endif
                                </form>
