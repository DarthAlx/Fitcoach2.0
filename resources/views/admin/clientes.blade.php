                                ...
                                @foreach ($usuarios as $usuario)
                                    <tr>
                                        ...
                                        <td><a href="#" class="btn btn-danger"
                                            ...
                                            <form style="display: none;" action="{{ url('/eliminar-cliente') }}"
                                                  method="post">
                                                {!! csrf_field() !!}
                                                {{ method_field('DELETE') }}
                                            ...
                                            <a href="#" class="btn btn-primary" data-toggle="modal"
                                               data-target="#tokenplus{{$usuario->id}}"><i class="fa fa-plus"></i></a>
                                            <a href="#" class="btn btn-info" data-toggle="modal"
                                               data-target="#tokenminus{{$usuario->id}}"><i class="fa fa-minus"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
