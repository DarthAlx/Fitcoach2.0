                                                ...
                                                <td>
                                                    ...
                                                    @if($clase->status!="COMPLETA"&&$clase->metadata!="cupon enviado"&&$clase->metadata!="abonada a coach")
                                                        <button type="button" class="btn btn-primary" name="button"
                                                                data-toggle="modal"
                                                                data-target="#completar{{$clase->id}}">Completar
                                                        </button>
                                                        <button type="button" class="btn btn-danger" name="button"
                                                                data-toggle="modal"
                                                                data-target="#cancelar{{$clase->id}}">Cancelar
                                                        </button>
                                                    @endif
                                                </td>
                                            </tr>
                                        ...
                                        <tr style="cursor: pointer;">
                                            ...
                                            <td>
                                                ...
                                                @if($clase->status!="COMPLETA"&&$clase->metadata!="token devuelto"&&$clase->metadata!="abonada a coach")
                                                    <button type="button" class="btn btn-primary" name="button"
                                                            data-toggle="modal" data-target="#completar{{$clase->id}}">
                                                        Completar
                                                    </button>
                                                    <button type="button" class="btn btn-danger" name="button"
                                                            data-toggle="modal" data-target="#cancelar{{$clase->id}}">
                                                        Cancelar
                                                    </button>
                                                @endif
                                            </td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <form action="{{ url('/comentarios') }}" method="post">
                                        ...
                                        <textarea rows="8" cols="80" class="form-control" name="comentarios"
                                                  placeholder="Comentarios" required>{{$clase->comentarios}}</textarea>
